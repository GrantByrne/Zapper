...
namespace Zapper.Data.Migrations
{
    ...
    [Migration("20250719020021_AddMissingDeviceProperties")]
    partial class AddMissingDeviceProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zapper.Core.Models.UsbRemote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("InterceptSystemButtons")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("LongPressTimeoutMs")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("RepeatDelayMs")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RepeatRateMs")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("UsbRemotes");
                });

            modelBuilder.Entity("Zapper.Core.Models.UsbRemoteButton", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("AllowInterception")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("IsSystemButton")
                        .HasColumnType("INTEGER");

                    b.Property<byte>("KeyCode")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RemoteId", "KeyCode")
                        .IsUnique();

                    b.ToTable("UsbRemoteButtons");
                });

            modelBuilder.Entity("Zapper.Core.Models.UsbRemoteButtonMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ButtonId", "DeviceId", "EventType")
                        .IsUnique();

                    b.ToTable("UsbRemoteButtonMappings");
                });
            ...
            modelBuilder.Entity("Zapper.Core.Models.UsbRemoteButton", b =>
                {
                    b.HasOne("Zapper.Core.Models.UsbRemote", "Remote")
                        .WithMany("Buttons")
            ...
            modelBuilder.Entity("Zapper.Core.Models.UsbRemoteButtonMapping", b =>
                {
                    b.HasOne("Zapper.Core.Models.UsbRemoteButton", "Button")
                        .WithMany("Mappings")

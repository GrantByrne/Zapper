...
namespace ZapperHub.Hubs;

public class ZapperHubSignalR : Hub
{
    private readonly ILogger<ZapperHubSignalR> _logger;

    public ZapperHubSignalR(ILogger<ZapperHubSignalR> logger)
    {
        _logger = logger;
    }
